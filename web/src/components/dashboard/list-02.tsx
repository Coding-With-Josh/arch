...
export default function List02({ transactions = TRANSACTIONS, className }: List02Props) {
  return (
    ...
    >
      <div className="p-4 max-h-[400px] overflow-y-auto scrollbar-custom scrollbar-container">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-sm font-semibold text-zinc-100">
            Recent Activity
            <span className="text-xs font-normal text-zinc-400 ml-1">(23 transactions)</span>
          </h2>
        ...
        <div className="space-y-1">
          {transactions.map((transaction) => (
            ...
            >
              ...
              >
                <transaction.icon className="w-4 h-4 text-zinc-100" />
              </div>

              <div className="flex-1 flex items-center justify-between min-w-0">
                <div className="space-y-0.5">
                  <h3 className="text-xs font-medium text-zinc-100">{transaction.title}</h3>
                  <p className="text-[11px] text-zinc-400">{transaction.timestamp}</p>
                </div>

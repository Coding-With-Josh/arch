...
const iconStyles = {
  savings: "bg-zinc-800 text-zinc-100",
...
export default function List03({ items = ITEMS, className }: List03Props) {
  return (
    <div className={cn("w-full overflow-x-auto scrollbar-custom", className)}>
        ...
        {items.map((item) => (
          ...
          >
            <div className="p-4 space-y-3">
              ...
              <div>
                <h3 className="text-sm font-medium text-zinc-100 mb-1">{item.title}</h3>
              ...
              {typeof item.progress === "number" && (
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="text-zinc-100">{item.progress}%</span>
                  </div>
              ...
              {item.amount && (
                <div className="flex items-center gap-1.5">
                  <span className="text-sm font-medium text-zinc-100">{item.amount}</span>
